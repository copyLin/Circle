...
/**
 * Created by Linxl on 2019/3/29.
 */

public class ImageGridViewAdapter extends RecyclerView.Adapter<ImageGridViewAdapter.ViewHolder>{
    ...
    public ImageGridViewAdapter(List<String> imgPaths){
        mStrings = imgPaths;
